...
ms_link = "https://raw.githubusercontent.com/zhengwu111/Proj4-STAT542/main/similarity_matrix_top_30.csv"
ms_filename = "ms.csv"
...
Rmat_link = "https://raw.githubusercontent.com/zhengwu111/Proj4-STAT542/main/Rmat_dropped.csv"
Rm_filename = "Rm.csv"
response = requests.get(Rmat_link)
with open(Rm_filename, "wb") as file:
    file.write(response.content)
Rmat = pd.read_csv(Rm_filename, index_col=0)
os.remove(Rm_filename)

mov_link = "https://raw.githubusercontent.com/zhengwu111/Proj4-STAT542/main/movies.dat"
